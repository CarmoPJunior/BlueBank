...
INSERT INTO `cliente` (`id`, `cpf`, `data_de_nascimento`, `nome`)
...
INSERT INTO `endereco` (`cep`, `cidade`, `estado`,`logradouro`,`numero`,`id_cliente`)
...
INSERT INTO `contato` (`email`, `numero_telefone`, `id_cliente`)
...
INSERT INTO `conta` (`id`, `agencia`, `numero_conta`, `saldo`, `status`, `tipo_conta`, `id_cliente`)
...
/*----------SAQUE----------*/
INSERT INTO `transacoes` (`data`, `tipo_transacao`, `valor`, `id_conta_origem`)
VALUES (NOW(), 0, 300.00 , 3);
INSERT INTO `transacoes` (`data`, `tipo_transacao`, `valor`, `id_conta_origem`)
VALUES (NOW(), 0, 150.00,  2);

/*----------DEPOSITO----------*/
INSERT INTO `transacoes` (`data`, `tipo_transacao`, `valor`, `id_conta_origem`)
VALUES (NOW(), 1, 1000.00, 1);
INSERT INTO `transacoes` (`data`, `tipo_transacao`, `valor`, `id_conta_origem`)
VALUES (NOW(), 1, 500.00, 2);


/*----------TRANSFERÊNCIA----------*/
INSERT INTO `transacoes` (`data`, `tipo_transacao`, `valor`, `id_conta_destino`, `id_conta_origem`)
VALUES (NOW(), 2, 800.00, 3, 2);
INSERT INTO `transacoes` (`data`, `tipo_transacao`, `valor`, `id_conta_destino`, `id_conta_origem`)
VALUES (NOW(), 2, 600.00, 4, 1);