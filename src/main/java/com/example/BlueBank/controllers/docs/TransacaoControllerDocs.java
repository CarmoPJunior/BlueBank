...
public interface TransacaoControllerDocs {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Transação encontrada!") })
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Transações encontradas!") })
...
//	public ResponseEntity<List<TransacaoDTO>> findByTipo(@PathVariable Integer id);
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Transações inserida com sucesso!"),
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Deposito realizado com sucesso!"),
			@ApiResponse(code = 404, message = "Conta não encontrada!"),
			@ApiResponse(code = 400, message = "Requisição possui campos inválidos"),
			@ApiResponse(code = 401, message = "Conta Bloqueada!") })
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Saque realizado com sucesso!"),
			@ApiResponse(code = 404, message = "Conta não encontrada!"),
			@ApiResponse(code = 400, message = "Requisição possui campos inválidos"),
			@ApiResponse(code = 401, message = "Saldo Insuficiente!"),
			@ApiResponse(code = 401, message = "Conta Bloqueada!") })
