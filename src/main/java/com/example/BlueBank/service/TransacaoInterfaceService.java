...
public interface TransacaoInterfaceService {
	...
	TransacaoDTO transferenciaContas(Conta origem, Conta destino, Double valor)
	...
	TransacaoDTO saque(Conta conta, Double valor)
			throws SaldoInsuficienteException, ContaNaoEncontradaException, ContaBloqueadaException;
	...
	List<List<TransacaoDTO>> obterPorTipoTransacao(Integer id);
